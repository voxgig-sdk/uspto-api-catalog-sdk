# UsptoApiCatalog SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions UsptoApiCatalogSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both UsptoApiCatalogSDK(...) and UsptoApiCatalogSDK.test(...) become
#      UsptoApiCatalogSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "usptoapicatalog_sdk"
_SDK_CLASS = "UsptoApiCatalogSDK"
