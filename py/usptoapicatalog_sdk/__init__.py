...
from usptoapicatalog_sdk.utility import register

# Load features
from usptoapicatalog_sdk.feature.base_feature import UsptoApiCatalogBaseFeature
from usptoapicatalog_sdk.features import _has_feature, _make_feature
...
class UsptoApiCatalogSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = UsptoApiCatalogUtility()
    ...
    def get_utility(self):
        return UsptoApiCatalogUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("UsptoApiCatalogSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Patent(self, data=None) -> "PatentEntity":
        ...
        from usptoapicatalog_sdk.entity.patent_entity import PatentEntity
    ...
    def Trademark(self, data=None) -> "TrademarkEntity":
        ...
        from usptoapicatalog_sdk.entity.trademark_entity import TrademarkEntity
