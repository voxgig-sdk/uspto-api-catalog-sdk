...
func registerSDKWords(r *eng.Registry, client *sdk.UsptoApiCatalogSDK) {
...
func runOp(client *sdk.UsptoApiCatalogSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
