...
type UsptoApiCatalogSDK struct {
	Mode     string
...
func (sdk *UsptoApiCatalogSDK) OptionsMap() map[string]any {
...
func (sdk *UsptoApiCatalogSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *UsptoApiCatalogSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *UsptoApiCatalogSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *UsptoApiCatalogSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *UsptoApiCatalogSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *UsptoApiCatalogSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("UsptoApiCatalogSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *UsptoApiCatalogSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *UsptoApiCatalogSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("UsptoApiCatalogSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *UsptoApiCatalogSDK {
	...
	sdk := NewUsptoApiCatalogSDK(sdkopts)
	sdk.Mode = "test"
