...
const testSeed = `map[string]any{"entity": map[string]any{"patent": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "trademark": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
