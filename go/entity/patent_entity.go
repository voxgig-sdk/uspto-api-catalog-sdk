...
func NewPatentEntity(client *core.UsptoApiCatalogSDK, entopts map[string]any) *PatentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PatentEntity) GetName() string { return e.name }
...
func (e *PatentEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PatentEntity) Deleted() bool {
	return e.deleted
}


func (e *PatentEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPatentEntity(e.client, opts)
}

func (e *PatentEntity) Data(args ...any) any {
...
func (e *PatentEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Patent; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PatentEntity) DataTyped(data ...Patent) Patent {
	if len(data) > 0 {
		return typedFrom[Patent](e.Data(asMap(data[0])))
	}
	return typedFrom[Patent](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Patent (all fields
// optional at the wire level).
func (e *PatentEntity) MatchTyped(match ...Patent) Patent {
	if len(match) > 0 {
		return typedFrom[Patent](e.Match(asMap(match[0])))
	}
	return typedFrom[Patent](e.Match())
}
...
func (e *PatentEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PatentEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PatentLoadMatch and returns an Patent. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PatentEntity) LoadTyped(reqmatch PatentLoadMatch, ctrl map[string]any) (Patent, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Patent{}, err
	}
	return typedFrom[Patent](res), nil
}




func (e *PatentEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// PatentListMatch and returns []Patent. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PatentEntity) ListTyped(reqmatch PatentListMatch, ctrl map[string]any) ([]Patent, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Patent](res), nil
}



func (e *PatentEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PatentEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PatentEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PatentEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
