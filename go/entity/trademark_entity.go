...
import (
	...
	vs "github.com/voxgig-sdk/uspto-api-catalog-sdk/go/utility/struct"
)

type TrademarkEntity struct {
	name    string
	client  *core.UsptoApiCatalogSDK
...
func NewTrademarkEntity(client *core.UsptoApiCatalogSDK, entopts map[string]any) *TrademarkEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TrademarkEntity) GetName() string { return e.name }
...
func (e *TrademarkEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TrademarkEntity) Deleted() bool {
	return e.deleted
}


func (e *TrademarkEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTrademarkEntity(e.client, opts)
}

func (e *TrademarkEntity) Data(args ...any) any {
...
func (e *TrademarkEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Trademark; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TrademarkEntity) DataTyped(data ...Trademark) Trademark {
	if len(data) > 0 {
		return typedFrom[Trademark](e.Data(asMap(data[0])))
	}
	return typedFrom[Trademark](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Trademark (all fields
// optional at the wire level).
func (e *TrademarkEntity) MatchTyped(match ...Trademark) Trademark {
	if len(match) > 0 {
		return typedFrom[Trademark](e.Match(asMap(match[0])))
	}
	return typedFrom[Trademark](e.Match())
}
...
func (e *TrademarkEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TrademarkEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TrademarkLoadMatch and returns an Trademark. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *TrademarkEntity) LoadTyped(reqmatch TrademarkLoadMatch, ctrl map[string]any) (Trademark, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Trademark{}, err
	}
	return typedFrom[Trademark](res), nil
}




func (e *TrademarkEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// TrademarkListMatch and returns []Trademark. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TrademarkEntity) ListTyped(reqmatch TrademarkListMatch, ctrl map[string]any) ([]Trademark, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Trademark](res), nil
}



func (e *TrademarkEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TrademarkEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TrademarkEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TrademarkEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
