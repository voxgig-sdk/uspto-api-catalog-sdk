# UsptoApiCatalog Golang SDK Reference

Complete API reference for the UsptoApiCatalog Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *UsptoApiCatalogSDK`
...
#### `Patent(data map[string]any) UsptoApiCatalogEntity`

Create a new `Patent` entity instance. Pass `nil` for no initial data.

#### `Trademark(data map[string]any) UsptoApiCatalogEntity`
