...
The Golang SDK for the UsptoApiCatalog API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/uspto-api-catalog-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/uspto-api-catalog-sdk=../path/to/github.com/voxgig-sdk/uspto-api-catalog-sdk
```
...
```
github.com/voxgig-sdk/uspto-api-catalog-sdk/
...
The root package (`github.com/voxgig-sdk/uspto-api-catalog-sdk`) re-exports everything needed
