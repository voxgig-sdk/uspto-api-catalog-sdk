// Command UsptoApiCatalog-mcp is an MCP server exposing the UsptoApiCatalog
// SDK as MCP tools.
//
// Two tools are registered:
//
//	UsptoApiCatalog_list  — list records of an entity
//	UsptoApiCatalog_load  — load a single record of an entity
//
