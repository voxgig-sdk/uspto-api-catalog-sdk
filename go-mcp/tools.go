...
type Args struct {
	Entity string         `json:"entity" jsonschema:"patent | trademark"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.UsptoApiCatalogSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "uspto-api-catalog_list",
		Description: "List records from UsptoApiCatalog. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "uspto-api-catalog_load",
		Description: "Load a single record from UsptoApiCatalog. " +
...
func runOp(client *sdk.UsptoApiCatalogSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.UsptoApiCatalogSDK, name string) (sdk.UsptoApiCatalogEntity, error) {
	switch strings.ToLower(name) {
	case "patent":
		return client.Patent(nil), nil
	case "trademark":
		return client.Trademark(nil), nil
