...
module UsptoApiCatalogTestRunner
  ...
  def self.env_override(m)
    live = getenv("USPTOAPICATALOG_TEST_LIVE")
    override = getenv("USPTOAPICATALOG_TEST_OVERRIDE")
    ...
    explain = getenv("USPTOAPICATALOG_TEST_EXPLAIN")
    m["USPTOAPICATALOG_TEST_EXPLAIN"] = explain if explain && !explain.empty?
