...
module UsptoApiCatalogTestRunner
  @env = {}
  ...
  def self.env_override(m)
    live = getenv("USPTO_API_CATALOG_TEST_LIVE")
    override = getenv("USPTO_API_CATALOG_TEST_OVERRIDE")
    ...
    explain = getenv("USPTO_API_CATALOG_TEST_EXPLAIN")
    m["USPTO_API_CATALOG_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = UsptoApiCatalogTestRunner
Helpers = UsptoApiCatalogHelpers
Vs = VoxgigStruct
