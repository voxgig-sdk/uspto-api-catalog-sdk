...
class TrademarkEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set USPTO_API_CATALOG_TEST_TRADEMARK_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def trademark_basic_setup(extra)
  ...
  entid_env_raw = ENV["USPTO_API_CATALOG_TEST_TRADEMARK_ENTID"]
