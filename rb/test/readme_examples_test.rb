...
#      offline in seeded test mode (UsptoApiCatalogSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "UsptoApiCatalog_sdk.rb")
  SDK_CLASS = "UsptoApiCatalogSDK"
