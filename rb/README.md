...
The Ruby SDK for the UsptoApiCatalog API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `UsptoApiCatalogError` (a `StandardError` subclass), so wrap
