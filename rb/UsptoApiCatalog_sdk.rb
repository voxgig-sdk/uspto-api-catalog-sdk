...
require_relative 'UsptoApiCatalog_types'
...
class UsptoApiCatalogSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = UsptoApiCatalogHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = UsptoApiCatalogHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, UsptoApiCatalogFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    UsptoApiCatalogUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = UsptoApiCatalogHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = UsptoApiCatalogHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = UsptoApiCatalogHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def raw_request(fetchargs = {})
    ...
    rescue UsptoApiCatalogError => err
    ...
    if fetched.is_a?(Hash)
      status = UsptoApiCatalogHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = UsptoApiCatalogError.new(
        "graphql_error", "UsptoApiCatalogSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = UsptoApiCatalogSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
