...
print_r(array_map(fn($item) => $item->data_get(), $patent));
```
...
```
php/
├── usptoapicatalog_sdk.php          -- Main SDK class
...
The main class (`usptoapicatalog_sdk.php`) exports the SDK class
