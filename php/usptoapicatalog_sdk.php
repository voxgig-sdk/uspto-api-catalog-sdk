...
class UsptoApiCatalogSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = UsptoApiCatalogHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = UsptoApiCatalogHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!UsptoApiCatalogFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, UsptoApiCatalogFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return UsptoApiCatalogUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = UsptoApiCatalogHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = UsptoApiCatalogHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = UsptoApiCatalogHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new UsptoApiCatalogError($op . "_allow",
                "UsptoApiCatalogSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = UsptoApiCatalogHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new UsptoApiCatalogError("graphql_error",
                "UsptoApiCatalogSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Patent($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_patent === null) {
                $this->_patent = new PatentEntity($this, null);
            }
            return $this->_patent;
        }
        return new PatentEntity($this, $data);
    }
    ...
    public function Trademark($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_trademark === null) {
                $this->_trademark = new TrademarkEntity($this, null);
            }
            return $this->_trademark;
        }
        return new TrademarkEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new UsptoApiCatalogSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
