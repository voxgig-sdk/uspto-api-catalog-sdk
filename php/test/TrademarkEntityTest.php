...
class TrademarkEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set USPTOAPICATALOG_TEST_TRADEMARK_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function trademark_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("USPTOAPICATALOG_TEST_TRADEMARK_ENTID");
