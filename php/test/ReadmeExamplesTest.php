...
// UsptoApiCatalog SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (UsptoApiCatalogSDK::test)
...
{
    private const SDK_CLASS = 'UsptoApiCatalogSDK';
    ...
    private const SDK_BASE = 'usptoapicatalog_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../usptoapicatalog_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
