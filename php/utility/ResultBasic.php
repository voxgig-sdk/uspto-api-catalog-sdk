...
// UsptoApiCatalog SDK utility: result_basic

class UsptoApiCatalogResultBasic
{
    public static function call(UsptoApiCatalogContext $ctx): ?UsptoApiCatalogResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof UsptoApiCatalogError) ? $result->err->msg : (string)$result->err;
