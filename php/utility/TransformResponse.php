...
// UsptoApiCatalog SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class UsptoApiCatalogTransformResponse
{
    public static function call(UsptoApiCatalogContext $ctx): mixed
    {
        ...
        $transform = UsptoApiCatalogHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
