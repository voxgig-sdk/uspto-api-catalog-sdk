...
// UsptoApiCatalog SDK utility: make_options

class UsptoApiCatalogMakeOptions
{
    ...
    public static function call(UsptoApiCatalogContext $ctx): array
    {
        ...
        //
        // `UsptoApiCatalogSchema::optspec()` is built from the model:
        ...
        $optspec = UsptoApiCatalogSchema::optspec();
