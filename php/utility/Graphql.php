...
// UsptoApiCatalog SDK utility: graphql
//
...
class UsptoApiCatalogGraphql
{
    ...
    // equivalent.
    public static function body(UsptoApiCatalogContext $ctx): mixed
    {
    ...
    public static function errors(UsptoApiCatalogContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
