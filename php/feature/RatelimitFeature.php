...
// UsptoApiCatalog SDK ratelimit feature
...
class UsptoApiCatalogRatelimitFeature extends UsptoApiCatalogBaseFeature
{
    ...
    private function _acquire(UsptoApiCatalogContext $ctx): void
    {
    ...
    private function _track(UsptoApiCatalogContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
