...
// UsptoApiCatalog SDK cache feature
...
class UsptoApiCatalogCacheFeature extends UsptoApiCatalogBaseFeature
{
    ...
    private function _through(UsptoApiCatalogContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
