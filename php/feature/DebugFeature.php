...
// UsptoApiCatalog SDK debug feature
...
class UsptoApiCatalogDebugFeature extends UsptoApiCatalogBaseFeature
{
    ...
    private function _finish(UsptoApiCatalogContext $ctx, bool $ok): void
    {
