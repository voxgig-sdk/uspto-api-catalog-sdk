...
// UsptoApiCatalog SDK streaming feature
...
class UsptoApiCatalogStreamingFeature extends UsptoApiCatalogBaseFeature
{
    ...
    private function _iterate(UsptoApiCatalogResult $result): \Generator
    {
    ...
    private function _streamable(UsptoApiCatalogContext $ctx): bool
    {
