...
// UsptoApiCatalog SDK telemetry feature
...
class UsptoApiCatalogTelemetryFeature extends UsptoApiCatalogBaseFeature
{
    ...
    private function _close(UsptoApiCatalogContext $ctx, bool $ok): void
    {
