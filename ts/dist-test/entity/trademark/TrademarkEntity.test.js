...
(0, node_test_1.describe)('TrademarkEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'trademark.' + op, live))
                return;
        }
        ...
        let trademark_ref01_data = Object.values(setup.data.existing.trademark)[0];
        // LIST
        const trademark_ref01_ent = client.Trademark();
        const trademark_ref01_match = {};
        const trademark_ref01_list = (await trademark_ref01_ent.list(trademark_ref01_match)).map((e) => e.data());
        // LOAD
        const trademark_ref01_match_dt0 = {};
        const trademark_ref01_data_dt0 = (await trademark_ref01_ent.load(trademark_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != trademark_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/trademark/TrademarkTestData.json');
    ...
    let idmap = transform(['trademark01', 'trademark02', 'trademark03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['USPTO_API_CATALOG_TEST_TRADEMARK_ENTID'];
...
//# sourceMappingURL=TrademarkEntity.test.js.map