...
(0, node_test_1.describe)('TrademarkDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.UsptoApiCatalogSDK({
    ...
    (0, node_test_1.test)('direct-load-trademark', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-trademark', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-trademark', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-trademark', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function liveScenariosActive() { return false && process.env.USPTO_API_CATALOG_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.UsptoApiCatalogSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.USPTO_API_CATALOG_APIKEY,
        }));
        let idmap = env['USPTO_API_CATALOG_TEST_TRADEMARK_ENTID'];
    ...
    const client = new __1.UsptoApiCatalogSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=TrademarkDirect.test.js.map