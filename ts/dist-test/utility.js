...
function envOverride(m) {
    if ('TRUE' === process.env.USPTO_API_CATALOG_TEST_LIVE ||
        'TRUE' === process.env.USPTO_API_CATALOG_TEST_OVERRIDE) {
    ...
    m.USPTO_API_CATALOG_TEST_EXPLAIN = process.env.USPTO_API_CATALOG_TEST_EXPLAIN || m.USPTO_API_CATALOG_TEST_EXPLAIN;
    return m;
}
