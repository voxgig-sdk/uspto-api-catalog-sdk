...
exports.UsptoApiCatalogEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends UsptoApiCatalogEntityBase<Advice>`.
class UsptoApiCatalogEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.UsptoApiCatalogEntityBase = UsptoApiCatalogEntityBase;
//# sourceMappingURL=UsptoApiCatalogEntityBase.js.map