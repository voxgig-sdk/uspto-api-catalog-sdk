...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.USPTOAPICATALOG_TEST_LIVE ||
    'TRUE' === process.env.USPTOAPICATALOG_TEST_OVERRIDE
  ) {
  ...
  m.USPTOAPICATALOG_TEST_EXPLAIN = process.env.USPTOAPICATALOG_TEST_EXPLAIN || m.USPTOAPICATALOG_TEST_EXPLAIN
