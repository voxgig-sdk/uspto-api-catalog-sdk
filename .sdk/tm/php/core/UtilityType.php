...
// UsptoApiCatalog SDK utility type

class UsptoApiCatalogUtility
{
    ...
    public static function copy(UsptoApiCatalogUtility $src): UsptoApiCatalogUtility
    {
        $u = new UsptoApiCatalogUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
