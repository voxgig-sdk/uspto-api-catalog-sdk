...
// UsptoApiCatalog SDK audit feature
...
class UsptoApiCatalogAuditFeature extends UsptoApiCatalogBaseFeature
{
    ...
    private function _emit(UsptoApiCatalogContext $ctx, string $outcome): void
    {
