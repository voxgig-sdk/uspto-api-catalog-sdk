...
// UsptoApiCatalog SDK netsim feature
...
class UsptoApiCatalogNetsimFeature extends UsptoApiCatalogBaseFeature
{
    ...
    private function _simulate(UsptoApiCatalogContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(UsptoApiCatalogContext $ctx, array $applied): void
    {
        $client = $this->client;
