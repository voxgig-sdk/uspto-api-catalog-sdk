...
// UsptoApiCatalog SDK idempotency feature
...
class UsptoApiCatalogIdempotencyFeature extends UsptoApiCatalogBaseFeature
{
    ...
    private function _mutating(UsptoApiCatalogContext $ctx): bool
    {
