...
// UsptoApiCatalog SDK metrics feature
...
class UsptoApiCatalogMetricsFeature extends UsptoApiCatalogBaseFeature
{
    ...
    private function _record(UsptoApiCatalogContext $ctx, bool $ok): void
    {
