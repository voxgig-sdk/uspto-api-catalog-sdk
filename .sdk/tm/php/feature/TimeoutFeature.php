...
// UsptoApiCatalog SDK timeout feature
...
class UsptoApiCatalogTimeoutFeature extends UsptoApiCatalogBaseFeature
{
    ...
    private function _with_timeout(UsptoApiCatalogContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(UsptoApiCatalogContext $_ctx, float $ms): void
    {
        $client = $this->client;
