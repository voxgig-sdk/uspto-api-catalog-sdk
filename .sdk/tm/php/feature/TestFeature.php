...
// UsptoApiCatalog SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class UsptoApiCatalogTestFeature extends UsptoApiCatalogBaseFeature
{
    ...
    public function init(UsptoApiCatalogContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (UsptoApiCatalogContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = UsptoApiCatalogParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (UsptoApiCatalogContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(UsptoApiCatalogContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = UsptoApiCatalogParam::call($ctx, $k);
