...
// UsptoApiCatalog SDK clienttrack feature
...
class UsptoApiCatalogClienttrackFeature extends UsptoApiCatalogBaseFeature
{
    ...
    public function PostConstruct(UsptoApiCatalogContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'UsptoApiCatalog-SDK';
