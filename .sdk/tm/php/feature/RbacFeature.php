...
// UsptoApiCatalog SDK rbac feature
...
class UsptoApiCatalogRbacFeature extends UsptoApiCatalogBaseFeature
{
    ...
    private function _required(UsptoApiCatalogContext $ctx): ?string
    {
    ...
    private function _reject(UsptoApiCatalogContext $ctx, string $required): void
    {
    ...
    private function _track(UsptoApiCatalogContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
