...
// UsptoApiCatalog SDK proxy feature
...
class UsptoApiCatalogProxyFeature extends UsptoApiCatalogBaseFeature
{
    ...
    public function init(UsptoApiCatalogContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (UsptoApiCatalogContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
