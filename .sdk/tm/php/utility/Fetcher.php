...
// UsptoApiCatalog SDK utility: fetcher

class UsptoApiCatalogFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; UsptoApiCatalogSDK/1.0)';
    ...
    public static function call(UsptoApiCatalogContext $ctx, string $fullurl, array $fetchdef): array
    {
