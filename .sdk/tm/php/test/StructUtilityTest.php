...
// UsptoApiCatalog SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = UsptoApiCatalogOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(UsptoApiCatalogOmni::structfix($now, Struct::undef()))
                        !== json_encode(UsptoApiCatalogOmni::structfix($val, Struct::undef()))) {
