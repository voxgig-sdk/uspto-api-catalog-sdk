...
// UsptoApiCatalog SDK pipeline test
//
...
{
    private static function utility(): UsptoApiCatalogUtility
    {
        return new UsptoApiCatalogUtility();
    }
    ...
    private static function ctx(array $over = []): UsptoApiCatalogContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new UsptoApiCatalogContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new UsptoApiCatalogOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof UsptoApiCatalogError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new UsptoApiCatalogOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = UsptoApiCatalogMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new UsptoApiCatalogOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = UsptoApiCatalogMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new UsptoApiCatalogOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = UsptoApiCatalogMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new UsptoApiCatalogSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = UsptoApiCatalogMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new UsptoApiCatalogResponse([]),
            'result' => new UsptoApiCatalogResult([]),
        ]);
        [, $err] = UsptoApiCatalogMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new UsptoApiCatalogSpec([]),
            'response' => null,
            'result' => new UsptoApiCatalogResult([]),
        ]);
        [, $err] = UsptoApiCatalogMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new UsptoApiCatalogSpec(['step' => 's']),
            'response' => new UsptoApiCatalogResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new UsptoApiCatalogResult([]),
        ]);
        [, $err] = UsptoApiCatalogMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new UsptoApiCatalogSpec(['step' => 's']),
            'response' => new UsptoApiCatalogResponse(self::resp(200, ['v' => 1])),
            'result' => new UsptoApiCatalogResult([]),
        ]);
        [, $err] = UsptoApiCatalogMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new UsptoApiCatalogSpec(['step' => 's']),
            'response' => new UsptoApiCatalogResponse(self::resp(200, ['v' => 2])),
            'result' => new UsptoApiCatalogResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        UsptoApiCatalogMakeResponse::call($ctx);
    ...
    {
        $preset = new UsptoApiCatalogResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new UsptoApiCatalogSpec([]),
            'response' => new UsptoApiCatalogResponse([]),
            'result' => new UsptoApiCatalogResult([]),
        ...
        [$got, $err] = UsptoApiCatalogMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new UsptoApiCatalogResult([])]);
        [, $err] = UsptoApiCatalogMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new UsptoApiCatalogSpec([]), 'result' => null]);
        [, $err] = UsptoApiCatalogMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new UsptoApiCatalogSpec(['step' => 's']),
            'result' => new UsptoApiCatalogResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new UsptoApiCatalogOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = UsptoApiCatalogMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new UsptoApiCatalogSpec(['step' => 's']),
            'result' => new UsptoApiCatalogResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new UsptoApiCatalogOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = UsptoApiCatalogMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new UsptoApiCatalogResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new UsptoApiCatalogSpec([]),
            'result' => new UsptoApiCatalogResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = UsptoApiCatalogMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = UsptoApiCatalogMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new UsptoApiCatalogError('boom', 'boom');
        $utility->fetcher = function (UsptoApiCatalogContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new UsptoApiCatalogSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = UsptoApiCatalogMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (UsptoApiCatalogContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = UsptoApiCatalogMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(UsptoApiCatalogResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        UsptoApiCatalogMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (UsptoApiCatalogContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new UsptoApiCatalogSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = UsptoApiCatalogMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new UsptoApiCatalogResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new UsptoApiCatalogSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = UsptoApiCatalogMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = UsptoApiCatalogMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = UsptoApiCatalogMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new UsptoApiCatalogResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, UsptoApiCatalogDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new UsptoApiCatalogResult(['ok' => false])]);
        $this->expectException(UsptoApiCatalogError::class);
        UsptoApiCatalogDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new UsptoApiCatalogResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', UsptoApiCatalogMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        UsptoApiCatalogMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new UsptoApiCatalogBaseFeature();
        $b = new UsptoApiCatalogBaseFeature();
        UsptoApiCatalogFeatureAdd::call($ctx, $a);
        UsptoApiCatalogFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): UsptoApiCatalogBaseFeature
    {
        $f = new UsptoApiCatalogBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        UsptoApiCatalogFeatureAdd::call($ctx, self::named_feature('a'));
        UsptoApiCatalogFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        UsptoApiCatalogFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        UsptoApiCatalogFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        UsptoApiCatalogFeatureAdd::call($ctx, $replace);
        ...
        UsptoApiCatalogFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): UsptoApiCatalogContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new UsptoApiCatalogSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = UsptoApiCatalogPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        UsptoApiCatalogPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new UsptoApiCatalogResponse(['headers' => null]),
            'result' => new UsptoApiCatalogResult([]),
        ]);
        UsptoApiCatalogResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        UsptoApiCatalogResultBody::call($ctx);
