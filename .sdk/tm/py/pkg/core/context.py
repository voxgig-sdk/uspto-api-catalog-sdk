...
from projectname_sdk.core.control import UsptoApiCatalogControl
...
class UsptoApiCatalogContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = UsptoApiCatalogControl()
        ...
        if isinstance(sp, UsptoApiCatalogSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, UsptoApiCatalogResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, UsptoApiCatalogResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return UsptoApiCatalogOperation({})
    ...
    def make_error(self, code, msg):
        return UsptoApiCatalogError(code, msg, self)
