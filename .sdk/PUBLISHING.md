...
|---|---|---|
| `ts/` | @voxgig-sdk/uspto-api-catalog-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/uspto-api-catalog-sdk \
      --repository voxgig-sdk/uspto-api-catalog-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/uspto-api-catalog-sdk` shows it, and
`npm trust revoke @voxgig-sdk/uspto-api-catalog-sdk --id=<id>` removes it.
