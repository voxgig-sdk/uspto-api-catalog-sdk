...
local TrademarkEntity = {}
TrademarkEntity.__index = TrademarkEntity


function TrademarkEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TrademarkEntity)
  self._name = "trademark"
  self._client = client
...
function TrademarkEntity:get_name()
  return self._name
end


function TrademarkEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TrademarkEntity.new(self._client, opts)
end
...
function TrademarkEntity:mark_deleted()
  self._deleted = true
end


function TrademarkEntity:deleted()
  return true == self._deleted
end


function TrademarkEntity:data_set(args)
  if args ~= nil then
...
function TrademarkEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TrademarkEntity:match_set(args)
  if args ~= nil then
...
function TrademarkEntity:match_get()
...
function TrademarkEntity:stream(action, args, callopts)
...
---@param reqmatch TrademarkLoadMatch
---@param ctrl? table
---@return Trademark
---@return string? err
function TrademarkEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch TrademarkListMatch
---@param ctrl? table
---@return Trademark[]
---@return string? err
function TrademarkEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function TrademarkEntity:_run_op(ctx, post_done)
  local utility = self._utility
